#!/usr/bin/env python3
"""A simple Flask application with localization and user support.

This application serves a webpage using Flask and Flask-Babel for
internationalization. Users can log in with their preferences for locale
and timezone, and the application adapts content accordingly.

Attributes:
    app (Flask): The main Flask application instance.
    babel (Babel): The Babel instance for localization support.
    users (dict): Sample user data containing localization settings.
"""
